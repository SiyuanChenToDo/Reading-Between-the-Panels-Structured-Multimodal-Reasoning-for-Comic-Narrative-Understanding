"""
Evaluate the multimodal temporal ordering model v2.
...
from train_v2 import ComicOrderModel, ComicDataset, collate_fn
...
def main():
    ...
    output_json["train"] = {k: {kk: vv for kk, vv in v.items() if kk not in ["predictions", "ground_truth"]} 
    ...
    output_json["valid"] = {k: {kk: vv for kk, vv in v.items() if kk not in ["predictions", "ground_truth"]} 
    ...
    out_path = os.path.join(script_dir, "../outputs/evaluation_results_v2.json")
